...
func resResGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "res/res.go", size: 12288, mode: os.FileMode(420), modTime: time.Unix(1566291379, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func resTemplateReadmeTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "res/template/readme.tpl", size: 210, mode: os.FileMode(420), modTime: time.Unix(1565687146, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
