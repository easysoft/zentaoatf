...
mock[`GET ${VUE_APP_APIHOST_MOCK || ''}/pages/detail`] = (req, res) => {
  res.send({
    code: 0,
    data: mockjs.mock({
      userInfo: {
...
mock[`POST ${VUE_APP_APIHOST_MOCK || ''}/pages/form`] = (req, res) => {
  res.send({
    code: 0,
    data: '',
    msg: '',
...
mock[`GET ${VUE_APP_APIHOST_MOCK || ''}/pages/list`] = (req, res) => {
  res.send({
    code: 0,
    data: mockjs.mock({
      total: 1000,
...
mock[`POST ${VUE_APP_APIHOST_MOCK || ''}/pages/list`] = (req, res) => {
  res.send({
    code: 0,
    data: '',
  });
...
mock[`PUT ${VUE_APP_APIHOST_MOCK || ''}/pages/list/*`] = (req, res) => {
  res.send({
    code: 0,
    data: '',
  });
...
mock[`DELETE ${VUE_APP_APIHOST_MOCK || ''}/pages/list/*`] = ( req, res) => {
  res.send({
    code: 0,
    data: '',
  });
