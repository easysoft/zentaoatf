...
require (
	...
	github.com/ozontech/allure-go v0.6.17 // indirect
	github.com/ozontech/allure-go/pkg/allure v0.6.3 // indirect
	github.com/ozontech/allure-go/pkg/framework v0.6.17 // indirect
